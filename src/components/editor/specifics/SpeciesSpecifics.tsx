...
export const SpeciesSpecifics: React.FC<Props> = ({ entity, allEntities, onUpdate, onCreateNew, isWikiMode }) => {
    return (
        <EditorGroup title="Species Specifics" icon={FileText} isWikiMode={isWikiMode}>
            <SmartSelect label="Related Species/Races/Flora/Fauna" ids={entity.relatedRaces || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, relatedRaces: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Evolved into Species/Races/Flora/Fauna" ids={entity.evolvedIntoRaces || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, evolvedIntoRaces: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Evolved from Species/Races/Flora/Fauna" ids={entity.evolvedFromRaces || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, evolvedFromRaces: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Characters of Species/Races/Flora/Fauna" ids={entity.pairedCharacter || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedCharacter: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Inhabited Locations" ids={entity.pairedConnectedPlaces || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedPlaces: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Connected to Culture/Art" ids={entity.relatedCultures || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, relatedCultures: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Commonly spoken Languages" ids={entity.localLanguages || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, localLanguages: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Common Skills/Spells/Other" ids={entity.pairedSkills || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedSkills: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Common Occupations/Classes" ids={entity.commonProfessions || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, commonProfessions: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Resources/Materials produced from the Species/Race/Flora/Fauna" ids={entity.pairedProducedFromResources || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedProducedFromResources: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Resources/Materials used by Species/Race/Flora/Fauna" ids={entity.pairedUsedResourcesResources || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedUsedResourcesResources: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Connected to important Events" ids={entity.connectedEvents || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, connectedEvents: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Connected to Resources/Materials" ids={entity.pairedConnectedResources || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedResources: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Common in Ideologies/Political groups" ids={entity.commonInPoliticalGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, commonInPoliticalGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Common in Organizations/Other groups" ids={entity.commonInOtherGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, commonInOtherGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Common in Teachings/Religious groups" ids={entity.commonInReligiousGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, commonInReligiousGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Common in Magical groups" ids={entity.commonInMagicGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, commonInMagicGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Common in Sciencific/Technological groups" ids={entity.commonInTechGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, commonInTechGroups: ids })} onCreate={onCreateNew} />
            <div className="lg:col-span-3">

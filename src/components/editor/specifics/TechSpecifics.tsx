...
export const TechSpecifics: React.FC<Props> = ({ entity, allEntities, onUpdate, onCreateNew, isWikiMode }) => {
    return (
        <EditorGroup title="Tech Specifics" icon={FileText} isWikiMode={isWikiMode}>
            ...
            <SmartSelect label="Technology/Science Users" ids={entity.pairedCharacter || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedCharacter: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Succeeding Sciences/Technological groups" ids={entity.succedingTechGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingTechGroup: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Preceding Sciences/Technological groups" ids={entity.preceedingTechGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingTechGroup: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Related Technologies/Sciences" ids={entity.pairedTech || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedTech: ids })} onCreate={onCreateNew} />

    ...
    return (
        <>
            <EditorGroup title="Governance" icon={Anchor} isWikiMode={isWikiMode}>
                <SmartSelect label="Capable of utilizing Spells/Magic" ids={entity.pairedMagic || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedMagic: ids })} onCreate={onCreateNew} />
            ...
            <EditorGroup title="Possessions" icon={Gem} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Related to other Items" ids={entity.pairedItems || []} type="item" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedItems: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Resources/Materials the Item is made of" ids={entity.pairedResourcesMade || []} type="item" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedResourcesMade: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Resources/Materials the Item produces" ids={entity.pairedResourcesProduced || []} type="item" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedResourcesProduced: ids })} onCreate={onCreateNew} />
            </EditorGroup>
            ...
            <EditorGroup title="Connections" icon={Globe} isWikiMode={isWikiMode}>
                <SmartSelect label="Involved in Events" ids={entity.pairedEvents || []} type="event" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedEvents: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Affected by Afflictions/Boons/Conditions" ids={entity.pairedConditionsAfflicting || []} type="condition" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConditionsAfflicting: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Connected to Locations" ids={entity.pairedConnectedLocations || []} type="location" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedLocations: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Connected to by Occupations/Classes" ids={entity.pairedConnectedProfessions || []} type="occupation" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedProfessions: ids })} onCreate={onCreateNew} />
            ...
            <EditorGroup title="Basic" icon={Info} isWikiMode={isWikiMode}>
                <SmartSelect label="Involved in Myths, legends and stories" ids={entity.pairedMyths || []} type="myth" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedMyths: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Allows for usage of Skills/Spells/Other" ids={entity.pairedSkillsUsing || []} type="ability" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedSkillsUsing: ids })} onCreate={onCreateNew} />
            </EditorGroup>
            ...
            <EditorGroup title="Stats" icon={Zap} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Commonly used with Skills/Spells/Other" ids={entity.pairedSkillsCommon || []} type="ability" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedSkillsCommon: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Created by Skills/Spells/Other" ids={entity.pairedSkillsCreate || []} type="ability" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedSkillsCreate: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Skills/Spells/Other requiring this Item" ids={entity.pairedSkillsRequire || []} type="item" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedSkillsRequire: ids })} onCreate={onCreateNew} />
            </EditorGroup>
        </>
    );
};

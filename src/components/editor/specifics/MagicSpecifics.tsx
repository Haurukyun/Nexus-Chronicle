    ...
    return (
        <>
            <EditorGroup title="Governance" icon={Anchor} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Magic/Spell Users" ids={entity.pairedCharacter || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedCharacter: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Succeeding Schools of Magic/Magical groups" ids={entity.succedingMagicGroup || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingMagicGroup: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Preceding Schools of Magic/Magical groups" ids={entity.preceedingMagicGroup || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingMagicGroup: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Related Schools of Magic" ids={entity.pairedSpells || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedSpells: ids })} onCreate={onCreateNew} />
            ...
            <EditorGroup title="Connections" icon={Globe} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Connected Political groups" ids={entity.pairedConnectedPolGroups || []} type="political" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedPolGroups: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Allied Political groups" ids={entity.pairedAllyPolGroups || []} type="political" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedAllyPolGroups: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Enemy Political groups" ids={entity.pairedEnemyPolGroups || []} type="political" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedEnemyPolGroups: ids })} onCreate={onCreateNew} />

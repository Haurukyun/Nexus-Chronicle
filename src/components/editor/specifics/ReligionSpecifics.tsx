...
import { Religion, WorldEntity, EntityType } from '../../../types';
...
interface Props {
    ...
    onUpdate: (data: Partial<Religion>) => void;
    onCreateNew: (type: EntityType, search: string, open: boolean) => string | void;
    isWikiMode: boolean;
}

export const ReligionSpecifics: React.FC<Props> = ({ entity, allEntities, onUpdate, onCreateNew, isWikiMode }) => {
    return (
        <EditorGroup title="Religion Specifics" icon={FileText} isWikiMode={isWikiMode}>
            ...
            <SmartSelect label="Succeeding Teachings/Religious groups" ids={entity.succedingRelGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingRelGroup: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Preceding Teachings/Religious groups" ids={entity.preceedingRelGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingRelGroup: ids })} onCreate={onCreateNew} />
            ...
            <FormInput label="Member count" value={entity.population || ""} onChange={(v: string) => onUpdate({ ...entity, population: v })} isWikiMode={isWikiMode} />
            ...
            <FormInput label="Form of religion" value={entity.formReligion || ""} onChange={(v: string) => onUpdate({ ...entity, formReligion: v })} isWikiMode={isWikiMode} />
            <FormInput label="Type of religion" value={entity.typeReligion || ""} onChange={(v: string) => onUpdate({ ...entity, typeReligion: v })} isWikiMode={isWikiMode} />
            <SmartSelect label="Related Religions" ids={entity.relatedReligions || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, relatedReligions: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Used Languages" ids={entity.localLanguages || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, localLanguages: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Connected Locations" ids={entity.collectedLocations || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, collectedLocations: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Connected Ideologies/Political groups" ids={entity.pairedConnectedPolGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedPolGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Allied Ideologies/Political groups" ids={entity.pairedAllyPolGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedAllyPolGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Enemy Ideologies/Political groups" ids={entity.pairedEnemyPolGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedEnemyPolGroups: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Allied Teachings/Religious groups" ids={entity.pairedAllyReligoiusGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedAllyReligoiusGroups: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Connected Schools of Magic/Magical groups" ids={entity.pairedConnectedMagicGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedMagicGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Allied Schools of Magic/Magical groups" ids={entity.pairedAllyMagicGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedAllyMagicGroups: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Enemy Schools of Magic/Magical groups" ids={entity.pairedEnemyMagicGroups || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedEnemyMagicGroups: ids })} onCreate={onCreateNew} />

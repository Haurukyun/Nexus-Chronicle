    ...
    return (
        <>
            <EditorGroup title="Governance" icon={Anchor} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Succeeding Teachings/Religious groups" ids={entity.succedingRelGroup || []} type="religious" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingRelGroup: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Preceding Teachings/Religious groups" ids={entity.preceedingRelGroup || []} type="religious" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingRelGroup: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Related Religions" ids={entity.relatedReligions || []} type="religious" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, relatedReligions: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Allied Teachings/Religious groups" ids={entity.pairedAllyReligoiusGroups || []} type="religious" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedAllyReligoiusGroups: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Connected Schools of Magic/Magical groups" ids={entity.pairedConnectedMagicGroups || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedMagicGroups: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Allied Schools of Magic/Magical groups" ids={entity.pairedAllyMagicGroups || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedAllyMagicGroups: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Enemy Schools of Magic/Magical groups" ids={entity.pairedEnemyMagicGroups || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedEnemyMagicGroups: ids })} onCreate={onCreateNew} />
            ...
            <EditorGroup title="Basic" icon={Info} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Used Languages" ids={entity.localLanguages || []} type="language" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, localLanguages: ids })} onCreate={onCreateNew} />
            ...
            <EditorGroup title="Connections" icon={Globe} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Connected Locations" ids={entity.collectedLocations || []} type="location" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, collectedLocations: ids })} onCreate={onCreateNew} />

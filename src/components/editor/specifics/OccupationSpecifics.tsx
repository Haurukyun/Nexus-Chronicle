...
export const OccupationSpecifics: React.FC<Props> = ({ entity, allEntities, onUpdate, onCreateNew, isWikiMode }) => {
    return (
        <EditorGroup title="Occupation Specifics" icon={FileText} isWikiMode={isWikiMode}>
            ...
            <SmartSelect label="Related Occupations/Classes" ids={entity.relatedProfessions || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, relatedProfessions: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Characters of the Occupation/Class" ids={entity.pairedCharacter || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedCharacter: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Common Species/Races/Flora/Fauna" ids={entity.commonRaces || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, commonRaces: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Used Resources/Materials" ids={entity.usedResources || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, usedResources: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Produced Resources/Materials" ids={entity.producedResources || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, producedResources: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Connected to Locations/Geography" ids={entity.connectedLocations || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, connectedLocations: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Languages" ids={entity.localLanguages || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, localLanguages: ids })} onCreate={onCreateNew} />

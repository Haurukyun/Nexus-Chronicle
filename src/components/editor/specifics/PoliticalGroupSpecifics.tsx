...
export const PoliticalGroupSpecifics: React.FC<Props> = ({ entity, allEntities, onUpdate, onCreateNew, isWikiMode }) => {
    return (
        <EditorGroup title="PoliticalGroup Specifics" icon={FileText} isWikiMode={isWikiMode}>
            ...
            <SmartSelect label="Succeeding Ideologies/Political groups" ids={entity.succedingPolGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingPolGroup: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Preceding Ideologies/Political groups" ids={entity.preceedingPolGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingPolGroup: ids })} onCreate={onCreateNew} />
            ...
            <FormInput label="Form of government" value={entity.formGovernment || ""} onChange={(v: string) => onUpdate({ ...entity, formGovernment: v })} isWikiMode={isWikiMode} />
            <SmartSelect label="Related Ideologies" ids={entity.realedTeachings || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, realedTeachings: ids })} onCreate={onCreateNew} />
            ...
            <SmartSelect label="Used Currencies" ids={entity.localCurrencies || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, localCurrencies: ids })} onCreate={onCreateNew} />

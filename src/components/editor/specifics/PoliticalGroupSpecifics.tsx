    ...
    return (
        <>
            <EditorGroup title="Governance" icon={Anchor} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Succeeding Ideologies/Political groups" ids={entity.succedingPolGroup || []} type="political" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingPolGroup: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Preceding Ideologies/Political groups" ids={entity.preceedingPolGroup || []} type="political" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingPolGroup: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Related Ideologies" ids={entity.realedTeachings || []} type="political" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, realedTeachings: ids })} onCreate={onCreateNew} />

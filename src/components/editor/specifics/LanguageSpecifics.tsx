...
import { Anchor, Globe, Info, Scroll } from 'lucide-react';
    ...
    return (
        <>
            <EditorGroup title="Basic" icon={Info} isWikiMode={isWikiMode}>
                <SmartSelect label="Language family" ids={entity.languageFamily || []} type="language" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, languageFamily: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Predecessor Languages" ids={entity.predecessorLanguages || []} type="language" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, predecessorLanguages: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Evolved into Languages" ids={entity.followingLanguages || []} type="language" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, followingLanguages: ids })} onCreate={onCreateNew} />
            ...
            <EditorGroup title="Connections" icon={Globe} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Spoken by Occupations/Classes" ids={entity.pairedConnectedProfessions || []} type="occupation" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, pairedConnectedProfessions: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Connected to Species/Races/Flora/Fauna" ids={entity.usedByRaces || []} type="species" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, usedByRaces: ids })} onCreate={onCreateNew} />
            </EditorGroup>
            <EditorGroup title="Governance" icon={Anchor} isWikiMode={isWikiMode}>
                <SmartSelect label="Spoken in Ideologies/Political groups" ids={entity.usedInPoliticalGroups || []} type="political" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, usedInPoliticalGroups: ids })} onCreate={onCreateNew} />
                ...
                <SmartSelect label="Spoken in Teachings/Religious groups" ids={entity.usedInReligiousGroups || []} type="religious" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, usedInReligiousGroups: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Spoken in Magical groups" ids={entity.usedInMagicalGroups || []} type="magic" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, usedInMagicalGroups: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Spoken in Science/Technology groups" ids={entity.usedInTechGroups || []} type="tech" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, usedInTechGroups: ids })} onCreate={onCreateNew} />
            </EditorGroup>
        </>
    );
};

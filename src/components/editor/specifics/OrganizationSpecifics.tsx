    ...
    return (
        <>
            <EditorGroup title="Governance" icon={Anchor} isWikiMode={isWikiMode}>
                ...
                <SmartSelect label="Succeeding Organizations/Other groups" ids={entity.succedingOtherGroup || []} type="organization" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingOtherGroup: ids })} onCreate={onCreateNew} />
                <SmartSelect label="Preceding Organizations/Other groups" ids={entity.preceedingOtherGroup || []} type="organization" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingOtherGroup: ids })} onCreate={onCreateNew} />

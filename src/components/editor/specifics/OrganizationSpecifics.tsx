...
export const OrganizationSpecifics: React.FC<Props> = ({ entity, allEntities, onUpdate, onCreateNew, isWikiMode }) => {
    return (
        <EditorGroup title="Organization Specifics" icon={FileText} isWikiMode={isWikiMode}>
            ...
            <SmartSelect label="Succeeding Organizations/Other groups" ids={entity.succedingOtherGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, succedingOtherGroup: ids })} onCreate={onCreateNew} />
            <SmartSelect label="Preceding Organizations/Other groups" ids={entity.preceedingOtherGroup || []} type="character" all={allEntities} isWikiMode={isWikiMode} onChange={(ids) => onUpdate({ ...entity, preceedingOtherGroup: ids })} onCreate={onCreateNew} />
            ...
            <FormInput label="Type of group" value={entity.groupType || ""} onChange={(v: string) => onUpdate({ ...entity, groupType: v })} isWikiMode={isWikiMode} />

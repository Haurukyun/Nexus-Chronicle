...
import { Organization, WorldEntity } from '../../../types';
...
export const OrganizationSpecificsViewer: React.FC<Props> = ({ entity, allEntities, onNavigate, isWikiMode }) => {
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 bg-slate-900/20 border border-slate-800 p-8 rounded-2xl">
                <h3 className="text-xs font-black uppercase mb-2 col-span-full tracking-widest text-[#fef08a] border-b border-slate-800/60 pb-3">Organization Intelligence</h3>
            <FieldRow label="Leading Figures (legacy)" value={entity.leaders || ""} isWikiMode={isWikiMode} />
            <LinksDisplay label="Succeeding Organizations/Other groups" ids={entity.succedingOtherGroup || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            <LinksDisplay label="Preceding Organizations/Other groups" ids={entity.preceedingOtherGroup || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            ...
            <FieldRow label="Type of group" value={entity.groupType || ""} isWikiMode={isWikiMode} />

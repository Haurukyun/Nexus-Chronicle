...
export const ReligionSpecificsViewer: React.FC<Props> = ({ entity, allEntities, onNavigate, isWikiMode }) => {
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 bg-slate-900/20 border border-slate-800 p-8 rounded-2xl">
                <h3 className="text-xs font-black uppercase mb-2 col-span-full tracking-widest text-[#fef08a] border-b border-slate-800/60 pb-3">Religion Intelligence</h3>
            <FieldRow label="Leading Figures (legacy)" value={entity.leaders || ""} isWikiMode={isWikiMode} />
            <LinksDisplay label="Succeeding Teachings/Religious groups" ids={entity.succedingRelGroup || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            <LinksDisplay label="Preceding Teachings/Religious groups" ids={entity.preceedingRelGroup || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            ...
            <FieldRow label="Form of religion" value={entity.formReligion || ""} isWikiMode={isWikiMode} />
            <FieldRow label="Type of religion" value={entity.typeReligion || ""} isWikiMode={isWikiMode} />
            <LinksDisplay label="Related Religions" ids={entity.relatedReligions || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            ...
            <LinksDisplay label="Connected Locations" ids={entity.collectedLocations || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            ...
            <LinksDisplay label="Allied Teachings/Religious groups" ids={entity.pairedAllyReligoiusGroups || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            ...
            <LinksDisplay label="Connected Schools of Magic/Magical groups" ids={entity.pairedConnectedMagicGroups || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            <LinksDisplay label="Allied Schools of Magic/Magical groups" ids={entity.pairedAllyMagicGroups || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
            <LinksDisplay label="Enemy Schools of Magic/Magical groups" ids={entity.pairedEnemyMagicGroups || []} all={allEntities} onNav={onNavigate} isWikiMode={isWikiMode} />
